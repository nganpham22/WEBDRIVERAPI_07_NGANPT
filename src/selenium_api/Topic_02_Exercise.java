...
public class Topic_02_Exercise {
  ...
  @Test
  //Script 04: Login with pass invalid
  public void Ex_04_Login_Pass_Invalid() {
	  //Step 01: Get page
	  driver.get("http://live.guru99.com/");
	  driver.manage().window().maximize();
	  driver.manage().timeouts().implicitlyWait(30, TimeUnit.SECONDS);
  ...
  @Test
  	//Script 05: Create an account
  public void Ex_05_Create_Account() {
	  //Step 01: Get page
	  driver.get("http://live.guru99.com/");
	  driver.manage().window().maximize();
	  driver.manage().timeouts().implicitlyWait(30, TimeUnit.SECONDS);
	  ...
	  //Step 04: Enter valid info: First Name/ Last Name/ Email Address/ Password/ Confirm Password
	  ...
	  String mess_reg = driver.findElement(By.xpath("//span[text() = 'Thank you for registering with Main Website Store.']")).getText();
	  Assert.assertEquals(mess_reg, "Thank you for registering with Main Website Store.");
	  driver.manage().timeouts().implicitlyWait(60, TimeUnit.SECONDS);
	  //Step 07: logout
